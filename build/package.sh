...
./build/ensymble.py mergesis --verbose  $CERT build/output/phonefight/phonefight.sis build/PythonForS60_1_4_5_3rdEd.sis build/aXYZ_3rd_N95_1_0_2_selfsigned.sisx build/N95AccelerometerPlugin.sis build/lightblue-0.3.3-s60-3rdEd.sisx build/misty_selfsigned_infinite.sisx build/output/phonefight_bundle/phonefight_bundle.sisx
