...
./build/ensymble.py py2sis --icon images/icon.svg --lang EN --extrasdir="root" --uid=0x20021BCD --version=1.0.0 --verbose $CERT --textfile="build/installtext.txt" --shortcaption "Phonefight" --vendor="lastminute.com labs" --drive=C --caption="Phonefight" --appname="Phonefight" python build/output/phonefight/phonefight.sis
